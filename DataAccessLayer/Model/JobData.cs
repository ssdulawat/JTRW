...
namespace DataAccessLayer.Model
{
    ...
    public class JobListFull
    {
        ...
        public float ServRate { get; set; }
        public bool AdminInvoice { get; set; }
    }

    public class JobSearchData_Result
    {
        public string JobNumber { get; set; }
